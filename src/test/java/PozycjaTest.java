...
public class PozycjaTest {
    @Test
    public void testTworzeniaPozycji(){
        //given
    ...
    public void testObliczWartosc(){
        //given
        Pozycja pozycja2 = new Pozycja("kiełbasa", 2, 5.0);
        //when
        double wartoscPozycji = pozycja2.obliczWartosc();
        //then
        assertEquals(Double.valueOf(10), Double.valueOf(wartoscPozycji));
    }

    @Test
    public void ObliczWartoscPoZmianie(){
        //given
        Pozycja pozycja3 = new Pozycja("kiełbasa", 2, 5.00);
        //when
    ...
    public void testToString(){
        //given
        Pozycja pozycja4 = new Pozycja("chleb", 5, 10);
        //when
